...
2. This file: src/Antigravity.AutoFoundation/PROJECT.md
3. Project roadmap: src/Antigravity.AutoFoundation/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.AutoFoundation/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.AutoFoundation/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.AutoFoundation/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.AutoFoundation/Antigravity.AutoFoundation.csproj
- Output artifact: Antigravity.AutoFoundation.dll
- Focused test project: tests/Antigravity.Core.Geometry.Tests/Antigravity.Core.Geometry.Tests.csproj
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- Commands/AutoFoundationCommand.cs
