...
2. This file: src/Antigravity.Formwork/PROJECT.md
3. Project roadmap: src/Antigravity.Formwork/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.Formwork/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.Formwork/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.Formwork/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.Formwork/Antigravity.Formwork.csproj
- Output artifact: Antigravity.Formwork.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- Commands/AutoFormworkCommand.cs
...
- docs/plans/2026-07-22-automatic-formwork-plan-correction.md
