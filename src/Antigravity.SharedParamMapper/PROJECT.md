...
2. This file: src/Antigravity.SharedParamMapper/PROJECT.md
3. Project roadmap: src/Antigravity.SharedParamMapper/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.SharedParamMapper/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.SharedParamMapper/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.SharedParamMapper/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.SharedParamMapper/Antigravity.SharedParamMapper.csproj
- Output artifact: Antigravity.SharedParamMapper.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- ParamMapperCommand.cs
