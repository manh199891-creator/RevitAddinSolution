...
2. This file: src/Antigravity.WallMepClash/PROJECT.md
3. Project roadmap: src/Antigravity.WallMepClash/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.WallMepClash/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.WallMepClash/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.WallMepClash/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.WallMepClash/Antigravity.WallMepClash.csproj
- Output artifact: Antigravity.WallMepClash.dll
...
- docs/plans/Plan_WallMepClash_v1.0.md
- docs/plans/wall_mep_clash_plan.md
