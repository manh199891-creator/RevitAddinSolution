...
2. This file: src/Antigravity.ZoneSplit/PROJECT.md
3. Project roadmap: src/Antigravity.ZoneSplit/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.ZoneSplit/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.ZoneSplit/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.ZoneSplit/docs/reports/ZoneSplit_Logic_Review_Implementation_20260516.md

## Project identity

- Project file: src/Antigravity.ZoneSplit/Antigravity.ZoneSplit.csproj
- Output artifact: Antigravity.ZoneSplit.dll
- Focused test project: src/Antigravity.ZoneSplit/tests/ZoneSplit.Tests.csproj
...
- docs/plans/ZoneSplit_BIM_Parameter_Plan.md
- docs/plans/ZoneSplit_MergeParts_ByZone_Plan.md
- docs/plans/ZoneSplit_PhysicalSplit_Plan.md
