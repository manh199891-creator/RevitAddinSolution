...
2. This file: src/Antigravity.HoanThien/PROJECT.md
3. Project roadmap: src/Antigravity.HoanThien/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.HoanThien/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.HoanThien/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.HoanThien/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.HoanThien/Antigravity.HoanThien.csproj
- Output artifact: Antigravity.HoanThien.dll
- Focused test project: tests/Antigravity.HoanThien.Tests/Antigravity.HoanThien.Tests.csproj
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- Commands/HoanThienCommand.cs
