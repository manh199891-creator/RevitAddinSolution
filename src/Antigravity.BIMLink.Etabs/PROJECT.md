...
Owns the ETABS integration boundary and adapter-specific engineering history.
...
2. This file: src/Antigravity.BIMLink.Etabs/PROJECT.md
3. Project roadmap: src/Antigravity.BIMLink.Etabs/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.BIMLink.Etabs/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.BIMLink.Etabs/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.BIMLink.Etabs/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.BIMLink.Etabs/Antigravity.BIMLink.Etabs.csproj
- Output artifact: Antigravity.BIMLink.Etabs.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: ETABS
