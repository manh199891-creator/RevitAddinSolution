...
Reserved/deferred source directory with no current .csproj; do not treat it as a buildable project until classified.
...
2. This file: src/Antigravity.Installer/PROJECT.md
3. Project roadmap: src/Antigravity.Installer/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.Installer/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.Installer/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.Installer/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: NONE
- Output artifact: NONE_DECLARED
...
- Smoke / last-known-good status: NOT_APPLICABLE_OR_NOT_CREATED
