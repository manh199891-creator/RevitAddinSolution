...
2. This file: src/Antigravity.TagArranger/PROJECT.md
3. Project roadmap: src/Antigravity.TagArranger/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.TagArranger/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.TagArranger/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.TagArranger/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.TagArranger/Antigravity.TagArranger.csproj
- Output artifact: Antigravity.TagArranger.dll
- Focused test project: tests/Antigravity.TagArranger.RevitTests/Antigravity.TagArranger.RevitTests.csproj
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- TagArrangeCommand.cs
...
- docs/plans/PLAN.md
- docs/plans/Plan_TagArranger_v1.0.md
