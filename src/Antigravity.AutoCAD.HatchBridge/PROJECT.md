...
Owns the AutoCAD integration boundary and adapter-specific engineering history.
...
2. This file: src/Antigravity.AutoCAD.HatchBridge/PROJECT.md
3. Project roadmap: src/Antigravity.AutoCAD.HatchBridge/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.AutoCAD.HatchBridge/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.AutoCAD.HatchBridge/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.AutoCAD.HatchBridge/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.AutoCAD.HatchBridge/Antigravity.AutoCAD.HatchBridge.csproj
- Output artifact: Antigravity.AutoCAD.HatchBridge.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: AutoCAD

### Declared entrypoints

- ExportHatchDefinitionsCommand.cs
