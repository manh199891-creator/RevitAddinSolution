...
2. This file: src/Antigravity.ArchModeling/PROJECT.md
3. Project roadmap: src/Antigravity.ArchModeling/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.ArchModeling/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.ArchModeling/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.ArchModeling/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.ArchModeling/Antigravity.ArchModeling.csproj
- Output artifact: Antigravity.ArchModeling.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: NONE_DECLARED

### Declared entrypoints

- Commands/DrawWallFromCadCommand.cs
- Commands/DrawFloorCeilFromCadCommand.cs
