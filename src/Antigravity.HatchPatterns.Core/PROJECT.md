...
Provides reusable shared/core behavior consumed by other Antigravity projects.
...
2. This file: src/Antigravity.HatchPatterns.Core/PROJECT.md
3. Project roadmap: src/Antigravity.HatchPatterns.Core/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.HatchPatterns.Core/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.HatchPatterns.Core/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.HatchPatterns.Core/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.HatchPatterns.Core/Antigravity.HatchPatterns.Core.csproj
- Output artifact: Antigravity.HatchPatterns.Core.dll
