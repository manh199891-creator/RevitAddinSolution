...
2. This file: src/Antigravity.Formwork.Core/PROJECT.md
3. Project roadmap: src/Antigravity.Formwork.Core/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.Formwork.Core/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.Formwork.Core/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.Formwork.Core/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.Formwork.Core/Antigravity.Formwork.Core.csproj
- Output artifact: Antigravity.Formwork.Core.dll
