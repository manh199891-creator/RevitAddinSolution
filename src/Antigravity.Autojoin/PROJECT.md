...
2. This file: src/Antigravity.Autojoin/PROJECT.md
3. Project roadmap: src/Antigravity.Autojoin/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.Autojoin/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.Autojoin/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.Autojoin/docs/reports/AutoJoin_Refactor_Full_Report.md

## Project identity

- Project file: src/Antigravity.Autojoin/Antigravity.Autojoin.csproj
- Output artifact: Antigravity.Autojoin.dll
...
- AutoJoinCommand.cs
- AutoJoinIntegrationTestCommand.cs
...
- docs/plans/AutoJoin_Dropdown_Foundation_Plan.md
