...
2. This file: src/Antigravity.DoorClearance/PROJECT.md
3. Project roadmap: src/Antigravity.DoorClearance/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.DoorClearance/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.DoorClearance/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.DoorClearance/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.DoorClearance/Antigravity.DoorClearance.csproj
- Output artifact: DoorClearanceBox.dll
...
- App.cs
- Commands/CreateClearanceBoxCommand.cs
- Commands/ClashControlCommand.cs
