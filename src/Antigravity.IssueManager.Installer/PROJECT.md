...
Classification: INSTALLER_SUPPORT
Activity: NO_ACTIVE_PLAN_RECORDED
Last reviewed: 2026-08-23

## Purpose

Owns installer/support packaging behavior rather than a Revit feature command.
...
2. This file: src/Antigravity.IssueManager.Installer/PROJECT.md
3. Project roadmap: src/Antigravity.IssueManager.Installer/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.IssueManager.Installer/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.IssueManager.Installer/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.IssueManager.Installer/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.IssueManager.Installer/Antigravity.IssueManager.Installer.csproj
- Output artifact: Antigravity.IssueManager.Installer.exe
