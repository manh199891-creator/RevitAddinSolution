...
Owns the Revit integration boundary and adapter-specific engineering history.
...
2. This file: src/Antigravity.BIMLink.Revit/PROJECT.md
3. Project roadmap: src/Antigravity.BIMLink.Revit/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.BIMLink.Revit/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.BIMLink.Revit/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.BIMLink.Revit/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.BIMLink.Revit/Antigravity.BIMLink.Revit.csproj
- Output artifact: Antigravity.BIMLink.Revit.dll
- Focused test project: NONE_DECLARED
- Runtime boundary: Revit
