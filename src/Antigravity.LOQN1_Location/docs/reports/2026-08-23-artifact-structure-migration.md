# Antigravity.LOQN1_Location - Artifact Structure Migration
...
Repository-level ambiguous/cross-solution artifacts were not guessed into this owner.

## Smoke / rollback profile

- Selected smoke checks: S0_STRUCTURAL, S1_BUILD_TEST, S2_REVIT_LOAD, S3_COMMAND_SAFE_CANCEL, S4_CRITICAL_PATH
- Last-known-good status: PENDING_CAPTURE
