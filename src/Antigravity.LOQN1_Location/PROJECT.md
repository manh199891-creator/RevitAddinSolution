...
# Antigravity.LOQN1_Location

Classification: REVIT_FEATURE_LEGACY_PACKAGING
Activity: NO_ACTIVE_PLAN_RECORDED
Last reviewed: 2026-08-23

## Purpose

Owns a Revit production feature; packaging identity requires separate legacy review.
...
2. This file: src/Antigravity.LOQN1_Location/PROJECT.md
3. Project roadmap: src/Antigravity.LOQN1_Location/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.LOQN1_Location/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.LOQN1_Location/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.LOQN1_Location/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.LOQN1_Location/Antigravity.LOQN1_Location.csproj
- Output artifact: VILAIVIET_LOQN1_Location.dll
