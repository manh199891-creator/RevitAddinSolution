...
2. This file: src/Antigravity.CadVoidPlacer/PROJECT.md
3. Project roadmap: src/Antigravity.CadVoidPlacer/docs/plans/ROADMAP.md
4. Active/detailed plan linked from the roadmap, if one is explicitly active
5. Smoke contract: src/Antigravity.CadVoidPlacer/smoke-tests/smoke-manifest.json when applicable
6. Last-known-good: src/Antigravity.CadVoidPlacer/smoke-tests/baseline/last-known-good.json when applicable
7. Latest project report: src/Antigravity.CadVoidPlacer/docs/reports/2026-08-23-artifact-structure-migration.md

## Project identity

- Project file: src/Antigravity.CadVoidPlacer/Antigravity.CadVoidPlacer.csproj
- Output artifact: Antigravity.CadVoidPlacer.dll
