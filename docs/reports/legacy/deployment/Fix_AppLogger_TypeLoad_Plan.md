...
3. **Script cũ**: `scripts/deploy/Deploy-ToRevit.ps1` trỏ sai đường dẫn (`E:\ANTIGRAVITY\Antigravity\Revit\RevitAddinSolution`) và chỉ copy 7 DLL module chính, KHÔNG copy dependency NuGet.

---

## 📋 Kế hoạch sửa (Tasks)

### Task 1: Cập nhật `scripts/deploy/Deploy-ToRevit.ps1` [Size: S - 1 file]
