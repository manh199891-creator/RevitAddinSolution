...
Approved spec: `docs/superpowers/plans/2026-07-17-ui-ux-strict-v3-spec.md`
...
**Files:** Modify `DeployToRevit.ps1` only if verification exposes packaging gaps; Test `Antigravity.sln`, `tests/ui/Assert-XamlContracts.ps1`, deployed Revit 2024 Addins folder
**Steps:**
...
- [ ] Ensure Revit is closed, deploy with `DeployToRevit.ps1 -NoPause`, and checksum all module DLLs.
